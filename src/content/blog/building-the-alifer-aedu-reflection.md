...
A few months ago, I gave a talk at the [ALife in Education (AEDU) workshop](https://www.youtube.com/watch?v=bHGJc1kqtG0), held online, under the slightly-provocative title *Artificial Life Is Everywhere — So Why Is It So Hard to Teach?*

The talk grew out of some thoughts that had been nagging at me for a while, and in particular since we ran the [Societal Outreach Initiatives for Artificial Life workshop at ALIFE 2025](/blog/alife-outreach-workshop/) at ALIFE 2025. That is, before we can begin to discuss *how* to teach artificial life, we probably need to admit that we don't fully agree on *what* it is, or *who* it is for.

The recording of my talk is below. My section runs from roughly 20:20 to 42:30.

<iframe width="100%" height="450" src="https://www.youtube.com/embed/bHGJc1kqtG0?start=1220" title="AEDU talk recording" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

I want to use this post to highlight, and to "promote" a bit more, the part that most seemed to resonate most with the audience. That is, a way of decomposing (the teaching of) artificial life that I described in the talk as **"building the ALifer."**

## The problem

The talk opened with an issue that I think that anyone who has tried to explain artificial life to an outsider will recognise. On the one hand, and to its strength, the field is incredibly rich and diverse. It is a melting pot of ideas, behaving at once as a *domain*, a *methodology*, and a *way of thinking*, functioning as a kind of sandbox where biology, computer science, physics, philosophy, cognitive science social sciences, mathematics, and so many other disciplines meet and recombine.
...
When we consider that each of these can encapsulate a certain entry point into our field (e.g. people coming from the life sciences have a good handle of the *domain* of ALife; people coming from computer science are well trained in a *methodology*, and complexity scientists understand the *mindset*), then "building the ALifer" becomes a matter of systematically moving someone across all three and letting them find their home in the middle.

![My conceptualisation of artificial life as the interplay of domain, methodology, and mindset, with ALife itself emerging in the middle, once all three are held together.](/blog/DMM.png)

Please feel free to check out the talk above (and the rest of the incredible workshop talks!) for more details. If any of this resonates with you, and/or if you want to contribute, develop this idea, or even disagree and propose alternatives, I'd really like to hear from you.

I'm also happy to present or discuss these ideas at workshops, seminars, reading groups. You can [get in touch here](mailto:imy@imytk.co.uk).

And if you already teach or work in this space, the two questions I keep coming back to are the ones I'll leave you with: *what do you do that you'd call artificial life. And, looking at the triangle above (or in the talk), what's missing?*

The slides for this talk are available [here](/files/alife-is-everywhere-slides.pdf), shared under a [CC BY-NC 4.0](https://creativecommons.org/licenses/by-nc/4.0/) licence.
